 ...
 * @author Davide
 */
public class EliminaPreferito extends HttpServlet {
...
JSONObject obj=new JSONObject();
    ...
    try{
            String query3 = "DELETE FROM PREFERITO WHERE IDPREFERITO=? AND IDUTENTE=?";
            PreparedStatement st3 = DBManager.db.prepareStatement(query3);
            st3.setInt(1, idpreferito);
            st3.setInt(2, idutente);
            st3.executeUpdate();
            st3.close();
obj.put("eliminapreferito", "true");
        } catch (SQLException e) {
obj.put("eliminapreferito", "false");
        }
    out.print(obj);
    }
